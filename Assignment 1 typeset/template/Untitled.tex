...
\newline
The outcomes associate with the event textbf{A}:
\newline
$\textbf{A} ={(S_1,P_1),(S_1,P_2),(S_2,P_1),(S_2,P_2),(S_3,P_1),(S_3,P_2), (P_1,P_2)}$
...
\newline
So for some $x$ it is impossible for $x\in (A \cap B)$ and $x\in (A^C\cap B^C)$.
\end{homeworkProblem}
